...
--
-- Host: localhost
-- Generation Time: Mar 25, 2015 at 11:45 AM
...
(82, 51, 48, 32, 1, 0, 'wednesday', '2015-03-25', '', 1, '2015-03-25 06:20:44', '2015-03-25 06:20:44'),
(87, 1, 48, 32, 1, 0, 'wednesday', '2015-03-25', '', 1, '2015-03-25 07:11:22', '2015-03-25 07:11:22');
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT AUTO_INCREMENT=76 ;
...
CREATE TABLE IF NOT EXISTS `order_items` (
  ...
  `modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT AUTO_INCREMENT=134 ;
...
(129, 71, 45, 'Joseph last', 'Rice & vegetables in banana leaf', 'wednesday', '05:00:00', '08:00:00', '2015-03-25', 2, '0.00', '12.00', '24.00', '0', '2015-03-25 03:01:26', '2015-03-25 03:01:26'),
(130, 72, 45, 'Joseph last', 'Rice & vegetables in banana leaf', 'wednesday', '05:00:00', '08:00:00', '2015-03-25', 1, '0.00', '12.00', '12.00', '0', '2015-03-25 03:07:59', '2015-03-25 03:07:59'),
(131, 73, 47, 'Joseph last', 'Green beans curry (10 servings)', 'friday', '04:00:00', '08:00:00', '2015-03-27', 1, '0.00', '12.00', '12.00', '0', '2015-03-25 03:11:09', '2015-03-25 03:11:09'),
(132, 74, 47, 'Joseph last', 'Green beans curry (10 servings)', 'friday', '04:00:00', '08:00:00', '2015-03-27', 1, '0.00', '12.00', '12.00', '0', '2015-03-25 03:13:17', '2015-03-25 03:13:17'),
(133, 75, 42, 'Raj kumar', 'Sri Lankan Crab Curry', 'wednesday', '08:00:00', '10:00:00', '2015-03-25', 1, '0.00', '15.00', '15.00', '0', '2015-03-25 06:17:15', '2015-03-25 06:17:15');
...
(61, 10, NULL, 57, 'Lamb tajine (serves 3)', '00:00:00', '00:00:00', '00:00:00', 'Lamb-tajine-(serves-3)', '<p>Praesent aliquam id diam quis facilisis. Etiam porta sagittis aliquam. Sed nulla quam, placerat at iaculis pretium, viverra sed purus.</p>\r\n', 'Sed nulla quam, placerat at iaculis pretium, viverra sed purus.  ', 'Curabitur nisi sapien', 'A placerat at iaculis pretium, viverra sed purus.  ', 'meal1426030034.jpg', '19.99', NULL, NULL, 308, 1, 1, 0, 'wednesday', 1, '2015-03-06 22:13:51', '2015-03-10 18:27:14'),
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT AUTO_INCREMENT=90 ;
...
(1, 'admin', 'admin', NULL, 'admin', 'e4b93d46b915b203d091339f83a1364196d4258f', '', 'admin@admin.com', 1, 'delhi', 'india', 'chef3.jpg', NULL, NULL, NULL, NULL, 1, 1, 1, 0, NULL, '122.177.40.173', '2015-03-25 07:36:48', '2011-09-26 00:34:07', '2015-03-25 07:36:48'),
...
(51, 'customer', 'jadhu', 'nadarajah', 'jadhu@yumplate.com', 'de2768ed34b73b73c451bfdd4c4dd923045ef6f8', '', 'jadhu@yumplate.com', 1, 'toronto', 'ontario', 'DSC00377.JPG', NULL, 'House', 'yes', 'yes', 0, 0, 0, 0, '2015-03-23 05:30:43', '129.137.144.114', '2015-03-25 06:51:01', '2015-03-06 11:57:18', '2015-03-25 06:51:01'),
...
(89, 'customer', 'kumar', 'pravendra', 'pravendra.kumar@webenturetech.com', 'e1c02571ad44dc2774f8fd7c10d0d067f91c850b', NULL, 'pravendra.kumar@webenturetech.com', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, NULL, NULL, '0000-00-00 00:00:00', '2015-03-25 02:51:08', '2015-03-25 02:51:08');
