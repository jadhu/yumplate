...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v2.3&appId=812553815506934";
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="yamplate-review ml15" >
                            <h4>YumCook <?php echo $product['User']['first_name'];?></h4>                          
                               ...
                               <?php echo $product['User']['description'];?>
                                ...
                                <div class=" social-tab">
                                    <ul>
                                        ...
                                        { ?>
                                       <fb:share-button type="button" href="<?php echo SITE_URL; ?>u/<?php echo $product['User']['username'];?>"></fb:share-button>
                                       <?php } else{ ?>
