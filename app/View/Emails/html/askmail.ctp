...
<center>
<table style="padding: 0; position: relative; width: 100%; ">
<tbody><tr>
<td align="center" style="text-align: center;">
<center>
<table style=" margin: 0 auto; text-align: inherit; width: 580px;">
<tbody><tr>
<td style="padding-right: 0; position: relative;">
...
<img  style="clear: both; display: block;  float: left;  max-width: 100%;  outline: medium none;  text-decoration: none;
    width: auto;" width="67px;" height="104px;" src="http://beta.yumplate.com/images/yumplate_logo2.jpg">
</a>
</td>
...
<tbody><tr>
<td>
<table class="row" style="padding: 0; position: relative; width: 100%; display: block;">
<tbody><tr>
<td style=" padding-right: 0; position: relative;">
<table style="width: 580px; margin: 0 auto;">
<tbody><tr>
<td>
<h1 style="color: #222222; font-family: 'Helvetica','Arial',sans-serif;  font-weight: normal;  line-height: 1.3;
    margin: 0; padding: 0; text-align: left; font-size:40px;">Hi, <?php echo $sendArr['Name']; ?></h1>
<p style="font-size: 18px; line-height: 21px;  margin-bottom: 10px;">Thank you for contacting us. A YumPlate staff will get back to you shortly.</p>
<p style="margin-bottom: 10px;"><span style="float: left; font-size: 13px;  font-weight: bold; width: 48%;"> Meal Name :</span>
<span style="float: left; width: 48%;"><?php echo $sendArr['product']; ?>.</span></p>
<p style="margin-bottom: 10px;"><span style="float: left; font-size: 13px;  font-weight: bold; width: 48%;">Cook :</span>
<span style="float: left; width: 48%;"><?php echo $sendArr['chef']; ?>.</span></p>
<p style="margin-bottom: 10px;"><span style="float: left; font-size: 13px;  font-weight: bold; width: 48%;">Order By:</span>
<span style="float: left; width: 48%;"><?php echo $sendArr['orderby']; ?>.</span></p>
<p style="margin-bottom: 10px;"><span style="float: left; font-size: 13px;  font-weight: bold; width: 48%;">Pickup By:</span>
<span style="float: left; width: 48%;"><?php echo $sendArr['pick']; ?>.</span></p>
<p style="margin-bottom: 10px;"><span style="float: left; font-size: 13px;  font-weight: bold; width: 48%;">About :</span>
<span style="float: left; width: 48%;"><?php echo $sendArr['queryfor']; ?>.</span></p>
<p style="margin-bottom: 10px;"> <span style="float: left; font-size: 13px;  font-weight: bold; width: 48%;">Question :</span>
<span style="float: left; width: 48%;"><?php echo $sendArr['query']; ?>.</span></p>
<p style="margin-bottom: 10px;"><span style="float: left; font-size: 13px;  font-weight: bold; width: 48%;"> Phone :</span>

<span style="float: left; width: 48%;"><?php echo $sendArr['phone']; ?>.</span> </p></td>
<td class="expander"></td>
</tr>
</tbody></table>
</td>
...
<table style="width: 580px; margin: 10px auto 0; padding: 0;  position: relative;">
<tbody><tr>
<td style="background: none repeat scroll 0 0 #ebebeb; padding: 0 0 10px;">
<table style=" width: 280px;">
<tbody><tr>
<td class="">
<h5 style="padding: 0 10px 10px; font-size: 24px; color: #222222; font-family: 'Helvetica','Arial',sans-serif;
    font-weight: normal; line-height: 1.3;  margin: 0; 
    text-align: left;">Connect With Us:</h5>
<table style="overflow: hidden; width: 100%;">
<tbody><tr>
<td>
<div style="width: 150px; padding-left: 30px;">     
<a class="fb-share" href="https://www.facebook.com/pages/Yumplate/346586222196988"><img alt="" class="icon1" style="margin-bottom: 8px;" src="http://beta.yumplate.com/images/facebook_mail.jpg"></a> 

<a class="tw-share" href="https://twitter.com/yum_plate"><img alt="" class="icon1" style="margin-bottom: 8px;" src="http://beta.yumplate.com/images/twitter_mail.jpg"></a>

<a class="tw-share" href="https://instagram.com/yumplate"><img alt="" class="icon1" src="http://beta.yumplate.com/images/insta_mail.jpg"></a>
</div>
<!--ul style="list-style:none; padding-left: 10px;">
<li style="display: inline-block; margin-right: 30px;">
<a href="https://www.facebook.com/pages/Yumplate/346586222196988"><img src="http://beta.yumplate.com/images/fb_color.png"></a>
</li>
<li style="display: inline-block; margin-right: 30px;">
<a href="https://twitter.com/yum_plate"><img src="http://beta.yumplate.com/images/twitter_color.png"></a>
</li>
<li style="display: inline-block; margin-right: 30px;">
<a href="https://instagram.com/yumplate"><img src="http://beta.yumplate.com/images/insta_color.png"></a>
</li>
</ul-->
...
<td style="padding-right: 0; background: none repeat scroll 0 0 #ebebeb;">
<table style="width: 280px; margin: 0 auto;">
<tbody><tr>
<td style=" padding: 0 0 10px;">
<h5 style="padding-bottom: 10px; font-size: 24px; color: #222222; font-family: 'Helvetica','Arial',sans-serif;
    font-weight: normal; line-height: 1.3;  margin: 0; 
    text-align: left;">Contact Info:</h5>
<p style="margin-bottom: 10px; font-size: 14px; line-height: 19px; color: #222222; font-weight: normal; font-family: 'Helvetica','Arial',sans-serif;">Phone: 647-607-0906</p>
<p style="margin-bottom: 10px; font-size: 14px; line-height: 19px; color: #222222; font-weight: normal; font-family: 'Helvetica','Arial',sans-serif;">Email: 
<a  style=" color: #2ba6cb; text-decoration: none;" href="mailto:info@yumplate.com">info@yumplate.com</a></p>
</td>
<td class="expander"></td>
...
<tbody><tr>
<td style="padding-right: 0; position: relative;">
<table style="width: 580px;margin: 10px auto;">
<tbody><tr>
<td align="center">
<center>
<p style="text-align:center; margin-bottom:0px; padding-bottom:10px; padding-top:10px; background:#ebebeb;"><a href="http://beta.yumplate.com/privacypolicy">Terms</a> | <a href="http://beta.yumplate.com/term_and_conditions">Privacy</a> </p>
<p style="font-size:14px; line-height:25px; margin-bottom:0px; padding-bottom:10px;text-align:center; background:#ebebeb;"><a href="http://beta.yumplate.com" target="_blank" style="font-size:14px">www.yumplate.com</a></p>
</center>
</td>
<td class="expander"></td>
</tr>
