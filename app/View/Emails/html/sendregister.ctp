...
<tbody><tr>
<td>
<h1>Hi, <?php echo $sendArr['fName'];?> <?php echo $sendArr['lName'];?> </h1>

<p style="font-size:14px">Thank you for registering with YumPlate.com  and welcome!</p>
<p style="font-size:14px">You are just the adventurous Yummer we have been looking for. As a member of the YumPlate community, we invite you to sample any one of our amazing meals from our various featured cooks.</p>
...
<p style="font-size:14px">Please help us spread the word about YumPlate and help us grow! </p> 
 <p style="font-size:14px">Happy eating!</p> 
  <p style="font-size:14px">From your YumPlate team</p> </td>
<td class="expander"></td>
</tr>
</tbody></table>
</td>
