        ...
        <table width="100%" align="center" cellspacing="0" cellpadding="0" >
            ...
            <tr>
                <td valign="top" align="center">
                    <table width="600" align="center" cellspacing="0" cellpadding="0" >						
                        <tr>
						<td valign="top" align="left" style="font-family: arial; font-size: 16px; line-height:20px; padding-bottom: 0px ;padding-top: 0px">						
                        ...
                        <tr>
						<td valign="top" align="left" style="font-family: arial; font-size: 14px; line-height:18px; padding-bottom: 20px ;padding-top: 0px">
                                ...
                                <table width="100%" align="center" cellspacing="0" cellpadding="0" style="background: #EBEBEB; padding-top: 15px; padding-right: 15px; padding-left: 15px; padding-bottom: 15px;">
                                    <tr>
                                        <td valign="top" align="left" width="50%" style="font-family: arial; font-size: 14px; padding-bottom: 10px ;padding-right: 10px">
                                            <font style="font-size: 20px; color: #000; font-family: arial; padding-bottom: 10px; display: inline-block; ">Connect With Us:</font>
                                            <br/>
                                            <table width="100%" align="center" cellspacing="0" cellpadding="0">
                                                <tr>
                                        ...
                                        <td valign="top" width="50%" align="left" style="font-family: arial; font-size: 14px; padding-bottom: 10px ;padding-left: 10px">
                                            <font style="font-size: 20px; color: #000; font-family: arial; padding-bottom: 10px; display: inline-block; ">Contact Info:</font>
                                            <br/>
